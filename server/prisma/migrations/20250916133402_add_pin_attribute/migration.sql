...
INSERT INTO "new_Message" ("chatId", "createdAt", "id", "message", "replyToId", "senderId", "status", "type", "updatedAt") SELECT "chatId", "createdAt", "id", "message", "replyToId", "senderId", "status", "type", "updatedAt" FROM "Message";
DROP TABLE "Message";
